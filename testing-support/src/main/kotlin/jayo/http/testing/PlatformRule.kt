...
import jayo.http.internal.platform.BouncyCastlePlatform
import jayo.http.internal.platform.ConscryptPlatform
import jayo.http.internal.platform.Platform
...
constructor(
    ...
    companion object {
        ...
        const val JDK21_PROPERTY = "jdk21"
        ...
        init {
            ...
            if (platformSystemProperty == JDK21_PROPERTY) {
...
//                        is OpenJSSEPlatform -> OPENJSSE_PROPERTY
                        is BouncyCastlePlatform -> BOUNCYCASTLE_PROPERTY
                        else -> if (isCorrettoInstalled) CORRETTO_PROPERTY else JDK21_PROPERTY
                    }
            }
