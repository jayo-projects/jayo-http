...
* We may use the collection abstraction from Netty that could be used in Headers (with case-insensitive keys), URL query
  parameters (with case-sensitive keys), and maybe more.
