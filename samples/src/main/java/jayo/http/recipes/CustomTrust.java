...
public final class CustomTrust {
    ...
    final X509Certificate comodoRsaCertificationAuthority = CertificateUtils.decodeCertificatePem(
            """
                    -----BEGIN CERTIFICATE-----
    ...
    final X509Certificate entrustRootCertificateAuthority = CertificateUtils.decodeCertificatePem(
            """
                    -----BEGIN CERTIFICATE-----
    ...
    final X509Certificate letsEncryptCertificateAuthority = CertificateUtils.decodeCertificatePem(
            """
                    -----BEGIN CERTIFICATE-----
    ...
    public CustomTrust() {
        // This implementation just embeds the PEM files in Java strings; most applications will instead read this from a
        // resource file that gets bundled with the application.

        ClientHandshakeCertificates certificates = ClientHandshakeCertificates.builder()
        ...
        client = JayoHttpClient.builder()
                .tlsConfig(ClientTlsSocket.builder(certificates))
                .build();
    }
