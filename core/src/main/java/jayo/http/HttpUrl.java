 ...
 */
public sealed interface HttpUrl permits HttpsUrl, RealHttpUrl {
    /**
     ...
     * not well-formed.
     */
    @Nullable HttpUrl resolve(final @NonNull String link);
    ...
    /**
     * @return a new {@link HttpUrl} built with this {@code configurer} and based on this URL.
     */
    @NonNull HttpUrl createNew(final @NonNull Consumer<Config> configurer);

    /**
     * @return a new {@link HttpUrl} built with this {@code configurer}.
     */
    static @NonNull HttpUrl create(final @NonNull Consumer<Config> configurer) {
        Objects.requireNonNull(configurer);
        final var builder = new RealHttpUrl().Builder();
        configurer.accept(builder);
        return builder.build();
    }

    /**
     * The configuration used to create a {@link HttpUrl} instance.
     */
    interface Config {
    ...
    /**
     * @return a new {@link HttpUrl} representing {@code url} if it is a well-formed HTTPS URL, or null if it isn't.
     */
    ...
    /**
     * @return a new {@link HttpUrl} representing {@code url} if its protocol is HTTPS, or null if it has any other
     * protocol.
     */
    ...
    /**
     * @return a new {@link HttpUrl} representing {@code uri} if its protocol is HTTPS, or null if it has any other
     * protocol.
     */
