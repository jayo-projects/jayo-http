...
final class AuthenticationUtils {
    ...
    static @NonNull ClientRequest addCredentialHeader(final @NonNull ClientRequest request,
        ...
        final var credentialHeader = forProxy ? "Proxy-Authorization" : "Authorization";
