...
public final class RealHandshake implements Handshake {
    ...
    public RealHandshake(final @NonNull TlsVersion tlsVersion,
                         final @NonNull CipherSuite cipherSuite,
                         final @NonNull List<Certificate> localCertificates,
        ...
        this.localCertificates = Objects.requireNonNull(localCertificates);
        this.peerCertificatesFn = Objects.requireNonNull(peerCertificatesFn);
    }
