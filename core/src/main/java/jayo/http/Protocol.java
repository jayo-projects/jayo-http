...
/**
 * Protocols that Jayo HTTP implements for
 * <a href="https://tools.ietf.org/html/draft-ietf-tls-applayerprotoneg">ALPN</a> selection.
 * <h2>Protocol vs Scheme</h2>
 * Despite its name, {@link URL#getProtocol()} returns the {@linkplain URI#getScheme() scheme} (http,
 * https, etc.) of the URL, not the protocol (http/1.1, spdy/3.1, etc.). Jayo HTTP uses the word <b>protocol</b> to
 * identify how HTTP messages are framed.
 */
public enum Protocol {
    /**
     * An obsolete plaintext framing protocol that does not use persistent sockets by default.
     * @implNote Current version of Jayo HTTP do not support this protocol.
     */
    HTTP_1_0("http/1.0"),
     ...
     * <p>
     * Jayo HTTP will implement <a href="https://tools.ietf.org/html/rfc7230">RFC 7230</a>, and tracks revisions to that
     * spec.
     * @implNote Current version of Jayo HTTP do not support this protocol.
     */
    HTTP_1_1("http/1.1"),
     ...
     * <p>
     * HTTP/2 requires at least TLS 1.2 support {@link CipherSuite#TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256}. Servers that
     * enforce this may send an exception message including the string {@code INADEQUATE_SECURITY}.
     */
    HTTP_2("h2"),
     ...
     * <p>
     * See also <a href="https://tools.ietf.org/html/rfc7540.section-3.4">Starting HTTP/2 with Prior Knowledge</a>
     */
    H2_PRIOR_KNOWLEDGE("h2_prior_knowledge"),

    /**
     * QUIC (Quick UDP Internet Connection) is a new multiplexed and secure transport atop UDP, designed from the ground
     * up and optimized for HTTP/2 semantics. HTTP/1.1 semantics are layered on HTTP/2.
     * @implNote Current version of Jayo HTTP do not support this protocol.
     */
    QUIC("quic"),
     ...
     * over QUIC, which is published as RFC 9000.
     * @implNote Current version of Jayo HTTP do not support this protocol.
     */
    HTTP_3("h3"),
    ;
        ...
        return switch (protocol) {
            ...
            default -> {
                ...
                if (protocol.startsWith("h3")) {
                    ...
                    throw new JayoException("Unexpected protocol: " + protocol);
                }
            }
        };
    }
