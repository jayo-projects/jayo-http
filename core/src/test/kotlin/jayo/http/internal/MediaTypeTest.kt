 ...
 *
 * This test includes tests from [Guava's](https://code.google.com/p/guava-libraries/) MediaTypeTest.
 */
class MediaTypeTest {
    ...
    @Test
    fun testCharsetIsOneOfManyParameters() {
     ...
     */
    @Test
    fun testCharsetNameIsSingleQuoted() {
        val mediaType = parse("text/plain;charset='utf-8'")
        assertEquals("UTF-8", mediaType.charsetName())
    }

    @Test
    fun testParseDanglingSemicolon() {
    ...
    @Test
    fun testUnsupportedCharset() {
        val mediaType = parse("text/plain; charset=utf-wtf")
        assertNull(mediaType.charsetName())
    }

    @Test
    fun testCharsetNameIsDoubleQuotedAndSingleQuoted() {
        val mediaType = parse("text/plain;charset=\"'utf-8'\"")
        assertNull(mediaType.charsetName())
    }

    @Test
    fun testCharsetNameIsDoubleQuotedSingleQuote() {
        val mediaType = parse("text/plain;charset=\"'\"")
        assertNull(mediaType.charsetName())
    }
