...
import jayo.http.internal.UrlComponentEncodingTester.Encoding
...
class HttpUrlTest {
    ...
    @Test
    fun incompleteBuilderUrlComposition() {
        val noHost =
    ...
    @Test
    fun incompleteDslUrlComposition() {
        val noHost =
            assertFailsWith<IllegalStateException> {
    ...
    @Test
    fun composeEncodesWhitespaceBuilder() {
        val url =
            HttpUrl.builder()
                .scheme("http")
                .username("a\r\n\u000c\t b")
    ...
    @Test
    fun composeEncodesWhitespaceDsl() {
        val url =
            HttpUrl.builder().build {
                scheme = "http"
                username = "a\r\n\u000c\t b"
    ...
    @Test
    fun composeFromEncodedComponentsDsl() {
        val url =
            HttpUrl.builder().build {
                scheme = "http"
                encodedUsername = "a:\u0001@/\\?#%25b"
    ...
    fun pathSegmentDsl() {
        ...
        assertThat(base.newBuilder().build {
            encodedPath = "/a/b/c"
            addPathSegments("d")
            addEncodedPathSegments("e")
            setPathSegment(0, "f")
            setEncodedPathSegment(1, "g")
            removePathSegment(0)
        }.encodedPath)
            .isEqualTo("/g/c/d/e")
    }
