...
import jayo.http.Cookie.parse
import jayo.http.Headers
import jayo.http.internal.RealCookie.MAX_DATE
...
class CookieTest {
    ...
    @Test
    fun trimLeadingAndTrailingWhitespaceFromName() {
    ...
    @Test
    fun trimLeadingAndTrailingWhitespaceFromValue() {
        assertThat(parse(url, "a= ")!!.value).isEqualTo("")
    ...
    @Test
    fun maxAge() {
        assertThat(parseCookie(50000L, url, "a=b; Max-Age=1")!!.expiresAt.toEpochMilli()).isEqualTo(51000L)
    ...
    @Test
    fun expiresDate() {
        assertThat(parse(url, "a=b; Expires=Thu, 01 Jan 1970 00:00:00 GMT")!!.expiresAt)
            .isEqualTo(instant("1970-01-01T00:00:00.000+0000"))
        assertThat(parse(url, "a=b; Expires=Wed, 09 Jun 2021 10:18:14 GMT")!!.expiresAt)
            .isEqualTo(instant("2021-06-09T10:18:14.000+0000"))
        assertThat(parse(url, "a=b; Expires=Sun, 06 Nov 1994 08:49:37 GMT")!!.expiresAt)
            .isEqualTo(instant("1994-11-06T08:49:37.000+0000"))
    }
    ...
    @Test
    fun domainIgnoredWithTrailingDot() {
        val cookie = parse(url, "a=b; domain=example.com.")
        assertThat(cookie!!.matches("http://example.com".toHttpUrl())).isTrue()
        assertThat(cookie.matches("http://www.example.com".toHttpUrl())).isFalse()
        assertThat(cookie.matches("http://square.com".toHttpUrl())).isFalse()
    ...
    @Test
    fun domainMatchesIpv6AddressWithCompression() {
    ...
    @Test
    fun domainMatchesIpv6AddressWithIpv4Suffix() {
        val cookie =
            parse(
    ...
    @Test
    fun ipv6AddressDoesntMatch() {
        val cookie = parse("http://[::1]/".toHttpUrl(), "a=b; domain=::2")
        assertThat(cookie).isNull()
    }

    @Test
    fun ipv6AddressMalformed() {
    ...
    @Test
    fun hostOnly() {
        assertThat(parse(url, "a=b")!!.isHostOnly).isTrue()
        assertThat(
            parse(url, "a=b; domain=example.com")!!.isHostOnly,
        ).isFalse()
    }
    ...
    @Test
    fun defaultPathIsUsedIfPathDoesntHaveLeadingSlash() {
        assertThat(
    ...
    @Test
    fun pathAttributeDoesntNeedToMatch() {
    ...
    @Test
    fun httpOnly() {
        assertThat(parse(url, "a=b")!!.isHttpOnly).isFalse()
        assertThat(parse(url, "a=b; HttpOnly")!!.isHttpOnly).isTrue()
    }

    @Test
    fun secure() {
        assertThat(parse(url, "a=b")!!.isSecure).isFalse()
        assertThat(parse(url, "a=b; Secure")!!.isSecure).isTrue()
    }

    @Test
    fun maxAgeTakesPrecedenceOverExpires() {
        // Max-Age = 1, Expires = 2. In either order.
        assertThat(parseCookie(0L, url, "a=b; Max-Age=1; Expires=Thu, 01 Jan 1970 00:00:02 GMT")!!.expiresAt.toEpochMilli())
            .isEqualTo(1000L)
        assertThat(parseCookie(0L, url, "a=b; Expires=Thu, 01 Jan 1970 00:00:02 GMT; Max-Age=1")!!.expiresAt.toEpochMilli())
            .isEqualTo(1000L)
        // Max-Age = 2, Expires = 1. In either order.
        assertThat(parseCookie(0L, url, "a=b; Max-Age=2; Expires=Thu, 01 Jan 1970 00:00:01 GMT")!!.expiresAt.toEpochMilli())
            .isEqualTo(2000L)
        assertThat(parseCookie(0L, url, "a=b; Expires=Thu, 01 Jan 1970 00:00:01 GMT; Max-Age=2")!!.expiresAt.toEpochMilli())
            .isEqualTo(2000L)
    }
    ...
    @Test
    fun lastMaxAgeWins() {
        assertThat(parseCookie(0L, url, "a=b; Max-Age=2; Max-Age=4; Max-Age=1; Max-Age=3")!!.expiresAt.toEpochMilli())
            .isEqualTo(3000L)
    }

    /** If a cookie incorrectly defines multiple 'Expires' attributes, the last one defined wins.  */
    @Test
    fun lastExpiresAtWins() {
        assertThat(
            parseCookie(
                0L,
                url,
    ...
    @Test
    fun maxAgeOrExpiresMakesCookiePersistent() {
        assertThat(parseCookie(0L, url, "a=b")!!.isPersistent).isFalse()
        assertThat(parseCookie(0L, url, "a=b; Max-Age=1")!!.isPersistent).isTrue()
        assertThat(parseCookie(0L, url, "a=b; Expires=Thu, 01 Jan 1970 00:00:01 GMT")!!.isPersistent)
            .isTrue()
    }
    ...
    @Test
    fun builderExpiresAt() {
        val cookie =
            Cookie.builder()
                .name("a")
                .value("b")
                .hostOnlyDomain("example.com")
                .expiresAt(instant("1970-01-01T00:00:01.000+0000"))
                .build()
    ...
    fun builderClampsMinDate() {
        val cookie =
            Cookie.builder()
                ...
                .value("b")
                .hostOnlyDomain("example.com")
                .expiresAt(instant("1970-01-01T00:00:00.000+0000"))
                .build()
    ...
    @Test
    fun trimLeadingAndTrailingWhitespaceFromSameSite() {
        assertThat(parse(url, "a=b; SameSite= ")!!.sameSite).isEqualTo("")
    ...
    private fun instant(s: String): Instant {
