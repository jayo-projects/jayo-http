...
class WebSocketExtensionsTest {
    ...
    fun noExtensionHeader() {
        assertThat(WebSocketExtensions.parse(Headers.of()))
    ...
    private fun parse(extension: String) = WebSocketExtensions.parse(Headers.of("Sec-WebSocket-Extensions", extension))

    private fun WebSocketExtensions(
        perMessageDeflate: Boolean = false,
        clientMaxWindowBits: Int? = null,
        clientNoContextTakeover: Boolean = false,
        serverMaxWindowBits: Int? = null,
        serverNoContextTakeover: Boolean = false,
        unknownValues: Boolean = false,
    ): WebSocketExtensions = jayo.http.internal.ws.WebSocketExtensions(
        perMessageDeflate,
        clientMaxWindowBits,
