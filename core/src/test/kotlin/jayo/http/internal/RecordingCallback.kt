...
class RecordingCallback : Callback {
    ...
    override fun onFailure(
        ...
        responses.add(RecordedResponse(call.request(), null, null, je))
    ...
    override fun onResponse(
        ...
        responses.add(RecordedResponse(call.request(), response, body, null))
        (this as Object).notifyAll()
    }

    /**
     * Returns the recorded response triggered by `request`. Throws if the response isn't enqueued before the timeout.
     */
    @Synchronized
