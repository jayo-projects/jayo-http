...
class UrlComponentEncodingTester private constructor() {
        ...
        apply {
            for ((codePoint, encoding) in encodings) {
                ...
                if (encoding == Encoding.FORBIDDEN) {
                    testForbidden(codePointString, component)
                    continue
                }
    ...
    enum class Component {
        ...
        /**
         * @return a character equivalent to 's' in this component. This is used to convert hostname
    ...
    companion object {
        ...
        /**
         * @return a new instance configured with a default encode set for the ASCII range. The specific
